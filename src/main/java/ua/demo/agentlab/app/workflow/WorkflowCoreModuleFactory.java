...
public class WorkflowCoreModuleFactory {
    ...
    public WorkflowCoreComponents create(ProjectProfile projectProfile) {
        ...
        return new WorkflowCoreComponents(
                ...
                discovery.uiInteractionInventoryAgent(),
                discovery.uiSpaComponentInteractionGraphAgent(),
                discovery.uiSpaTargetedVerificationAgent(),
                discovery.uiLiveSpaTargetedVerificationAgent(),
                discovery.uiSpaEvidenceRetentionAgent(),
                ...
                validation.generatedTestExecutionAgent(),
                validation.uiSpaSmokeEvidenceFeedbackAgent(),
