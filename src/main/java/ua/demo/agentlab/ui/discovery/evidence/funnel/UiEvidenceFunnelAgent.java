...
public final class UiEvidenceFunnelAgent implements WorkflowAgent,
    ...
    private final UiEvidenceFunnelAcceptanceGate acceptanceGate;
    private final AiArtifactPublisher artifactPublisher;

    public UiEvidenceFunnelAgent() {
        this(new UiEvidenceFunnelAssembler(), new UiEvidenceFunnelAcceptanceGate(), new AiArtifactPublisher());
    }

    UiEvidenceFunnelAgent(
            UiEvidenceFunnelAssembler assembler,
            UiEvidenceFunnelAcceptanceGate acceptanceGate,
    ...
    public UiEvidenceFunnelInput inputFrom(PipelineArtifactStore store, WorkflowState state) {
        ...
        return new UiEvidenceFunnelInput(runId, requirements, inventory, bindings, verification,
                targetStateBindings, aiContext);
    }
