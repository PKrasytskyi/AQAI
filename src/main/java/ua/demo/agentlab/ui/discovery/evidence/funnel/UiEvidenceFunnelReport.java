...
public record UiEvidenceFunnelReport(
    ...
    public UiEvidenceFunnelReport(
            String schemaVersion, String runId, boolean completenessPassed, boolean pomReadinessPassed,
            UiEvidenceFunnelMetrics metrics, List<UiEvidenceRequirementResult> requirements, List<String> findings
    ) {
        this(schemaVersion, runId, completenessPassed, pomReadinessPassed, metrics, requirements, findings, null);
    }
}
