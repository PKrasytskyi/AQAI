...
public class PageReadinessRuleResolverTest {
    ...
    public void appliesCapabilityOverridesFromProperties() {
        ...
        properties.setProperty("ui.discovery.readiness.dashboard.ready-text", "dashboard;welcome");
        ...
        Assert.assertEquals(rule.readyTextFragments(), java.util.List.of("dashboard", "welcome"));
