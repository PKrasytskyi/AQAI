...
public class StructuredSpaBehaviorBindingServiceTest {
    ...
    public void rejectsFilterBindingWhenSearchEvidenceIsNotConfirmed() {
        ...
        UiInteractionPage page = page("vacancies", "RECORD_LIST", ComponentType.FILTER_PANEL, List.of(search), List.of());
        ...
        var result = new StructuredSpaBehaviorBindingService().bind(List.of(contract),
                new UiInteractionInventory("v", SpaDiscoveryMode.TARGETED, List.of(page), List.of()),
    ...
    public void bindsModuleNavigationOnlyToConfirmedLocatorAndAction() {
        ...
        UiInteractionPage page = page("dashboard", "AUTHENTICATED_AREA", ComponentType.NAVIGATION, List.of(recruitment), List.of(openRecruitment));
    ...
    public void matchesNormalizedCapabilityTokensWithoutSubstringFallback() {
        ...
        CandidateActionEvidence openRecruitment = new CandidateActionEvidence("openRecruitment", "navigation", "CLICK",
                "recruitmentLink", 0.95d, List.of("recruitment"), List.of(), List.of(), List.of(), SpaEvidenceStatus.CANDIDATE);
        UiInteractionPage page = page("dashboard", "overview|AUTHENTICATED_AREA|MODULE_NAVIGATION", ComponentType.NAVIGATION,
    ...
    public void doesNotBindAnUnconfirmedNamedTargetToAnotherPageWithTheSameCapability() {
        ...
        UiInteractionPage candidates = new UiInteractionPage(
        ...
        var result = new StructuredSpaBehaviorBindingService().bind(List.of(contract),
                new UiInteractionInventory("v", SpaDiscoveryMode.TARGETED, List.of(candidates), List.of()),
    ...
    public void finalizesSelectionFromProvisionalSourceAndLiveEvidenceWithoutNavigationFlow() {
        ...
        var result = new StructuredSpaBehaviorBindingService().bind(
                List.of(contract), new UiInteractionInventory("v", SpaDiscoveryMode.TARGETED, List.of(page), List.of()), live,
    ...
    public void bindsSubmitFromConfirmedActionBeforeMatchingGenericFormText() {
        ...
        var result = new StructuredSpaBehaviorBindingService().bind(List.of(contract),
                new UiInteractionInventory("v", SpaDiscoveryMode.TARGETED, List.of(page), List.of()), verification).get(0);
    ...
    private TargetedLocatorVerification verifiedLocator(UiInteractionPage page, CandidateLocatorEvidence locator,
    ...
    private TargetedActionVerification verifiedAction(UiInteractionPage page, CandidateActionEvidence action,
                                                       String requirementId) {
    ...
    private UiInteractionPage page(String id, String capability, ComponentType type, List<CandidateLocatorEvidence> locators,
        ...
        return new UiInteractionPage(id, "Dashboard", "/dashboard", capability, "fp", null, List.of(component), List.of());
    }
}
