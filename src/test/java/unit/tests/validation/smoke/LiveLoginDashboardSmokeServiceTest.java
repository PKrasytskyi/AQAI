...
public class LiveLoginDashboardSmokeServiceTest {
    ...
    public void disabledLiveSmokeReturnsSkippedWithoutStartingBrowser() {
        ...
        try {
            LiveUiSmokeResult result = new LiveLoginDashboardSmokeService().smoke(new GeneratedUiSources(List.of(), List.of()));
