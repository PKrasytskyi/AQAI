    ...
    public void summaryExposesRetrievalHealthMetadata() {
        AiRunQualitySummary summary = new AiRunQualitySummaryService().summarize(new AiRunQualitySummaryInput(
                ...
                Map.of(
                        ...
                        "ui.knowledge.retrieval.qdrant.hit", "false",
                        "ui.knowledge.retrieval.mode", "stable-page-cache",
                        "ui.knowledge.retrieval.stable.cache.used", "true",
                        "ui.knowledge.retrieval.stale.evidence.rejected", "3",
                        "ui.knowledge.retrieval.vector.unavailable.reason", "embedding key missing"
                )
        ));

        Assert.assertTrue(summary.neo4jHit());
